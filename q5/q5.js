...
arr=['http://sousmonarbre.com/qphj/bd963843d2239ed78aa6f7b0a36b537d/qdp/shapely-table-mat-design-office-bay-decoration-mes-at-work-decorating-ideas-office-decoration-mes-design-ideas-cream-wall-paint-decoration-messroom-wooden-laminate-ing-tosca-color__office-decorating-ideas.jpg',
...
const csvWriter = createCsvWriter({
    path: 'file.csv',
    header: [{id:'old', title:'OLD'},
    {id:'new',title:'NEW'}]
});

arr.forEach(ele=>{
    let me=ele;
    shortUrl.short(ele,(ele,url)=>{
        let newurls=[{'old':me,
        'new':url}]
        csvWriter
        .writeRecords(newurls)
